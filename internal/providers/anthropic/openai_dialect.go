...
// lengkap.
//
// Struktur yang sama juga ada di paket google. Duplikasi itu disengaja: keduanya dimiliki
// adapter masing-masing, dan kontrak bersama di paket providers tidak boleh tumbuh hanya
// untuk melayani dua penerjemah.
...
// textDelta membungkus potongan teks menjadi delta dialek OpenAI.
func textDelta(text string) *oaDelta {
	return &oaDelta{Content: &text}
}
