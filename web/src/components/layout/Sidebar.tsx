...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        { name: 'Routing Rules', path: '/gateway/routing', icon: GitFork },
        { name: 'Rate Limits', path: '/gateway/rate-limits', icon: Gauge },
        { name: 'Budgets', path: '/gateway/budgets', icon: Coins },
        { name: 'Content Filters', path: '/gateway/filters', icon: ShieldAlert },
        { name: 'Bans', path: '/gateway/bans', icon: Ban },
        { name: 'Circuit Breakers', path: '/gateway/breakers', icon: ZapOff },
      ],
    },
    {
      ...
      items: [
        ...
        { name: 'Users & Roles', path: '/access/users', icon: Users },
        { name: 'Active Sessions', path: '/access/sessions', icon: Smartphone },
        { name: 'Webhooks', path: '/automation/webhooks', icon: Webhook },
      ],
    },
    {
      ...
      items: [
        ...
        { name: 'Background Jobs', path: '/system/jobs', icon: Clock },
        { name: 'Audit Logs', path: '/system/audit', icon: ScrollText },
