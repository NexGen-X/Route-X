          ...
          <div className="flex p-1 bg-bg-surface-2 rounded-inner border border-border">
            ...
            >
              ...
              <span className={`px-1.5 py-0.2 rounded-full text-[10px] ${
                mainTab === 'installed' ? 'bg-black/20 text-black font-bold' : 'bg-bg-surface-3 text-text-muted'
              }`}>
                {installedCount}
              </span>
            </button>
            ...
            >
              ...
              Katalog Lengkap
              <span className={`px-1.5 py-0.2 rounded-full text-[10px] ${
                mainTab === 'all' ? 'bg-black/20 text-black font-bold' : 'bg-bg-surface-3 text-text-muted'
              }`}>
                {totalCount}
              </span>
            </button>
