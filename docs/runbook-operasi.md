...
Restore ke database kosong (verifikasi berkala):
  ...
  # harus: 9 (migrasi 0001 sampai 0009)

Hasil uji 2026-09-09: dump 254 KB, 453 objek, restore ke DB baru
users/roles/models sama dengan sumber, schema_migrations=9.
