...
// ScalarJS memuat biner standalone Scalar API reference lokal untuk menyajikan
// antarmuka dokumentasi interaktif secara mandiri tanpa dependensi eksternal ke CDN publik.
// Hal ini memastikan antarmuka /docs mematuhi Content Security Policy (script-src 'self').
//
