...
// Alur 1 menguji login itu sendiri (tanpa sesi tersimpan).
// Alur 2-3 memakai sesi viewer tersimpan supaya hemat limiter login
// (20/IP/15 mnt): auth.setup.ts login tepat 1 kali lalu simpan storage.
test.describe('login', () => {
  ...
  test('login menolak password salah lalu menerima password benar', async ({
    page,
  }) => {
